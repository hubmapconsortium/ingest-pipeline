...
class InvalidStatusEmail(EmailTemplate):
    ...
    def format(self) -> tuple[str, str]:
        ...
        msg = [
            ...
            "",
            "<b>What to do next</b>",
            f"If you have questions about your {self.data.entity_type.lower()}, please schedule an appointment with Data Curator Brendan Honick (https://calendar.app.google/db2J6CDzZQuQnGHr6) or email ingest@hubmapconsortium.org. Do not respond to this email; this inbox is not monitored.",
        ]
        if self.data.error_dict:
            msg.extend(
                [
                    "",
                    "The error log is included below if you would like to make updates to your submission independently. It is not required for you to correct any errors before contacting our Data Curation Team. Please email ingest@hubmapconsortium.org if you believe you have repaired all validation errors so that we can re-validate your submission.",
                    "",
