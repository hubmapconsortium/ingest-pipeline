...
with DAG(
    ...
    pipeline_name = "ims-mxif-pipeline"
    ...
    def build_cwltool_cmd1(**kwargs):
        ...
        # data paths; TODO: get these from Airflow/API/etc.
        mxif_data_path = ...
        ims_pos_path = ...
        ims_neg_path = ...
    ...
    t_build_cmd1 = PythonOperator(
        task_id="build_cmd1", python_callable=build_cwltool_cmd1, provide_context=True,
    )
    ...
    t_build_cmd2 = PythonOperator(
        task_id="build_cmd2", python_callable=build_cwltool_cmd2, provide_context=True,
    )
    ...
    t_build_cmd3 = PythonOperator(
        task_id="build_cmd3", python_callable=build_cwltool_cmd3, provide_context=True,
    )
    ...
    t_send_create_dataset = PythonOperator(
        ...
        op_kwargs={
            ...
            "dataset_types": ["ims_mxif_cytokit_sprm"],
        },
    )
