...
default_args = {
    ...
    "xcom_push": True,
    "queue": get_queue_resource("imc_3d_3dcc"),
...
with HMDAG(
    ...
    user_defined_macros={
        ...
        "preserve_scratch": get_preserve_scratch_resource("imc_3d_3dcc"),
    },
) as dag:
    pipeline_name = "imc-3d-segmentation"
    workflow_version = "1.0.0"
    workflow_description = "The 3D IMC pipeline segments nuclei and cells using 3DCellComposer, and performs spatial analysis of expression data using SPRM, which computes various measures of analyte intensity per cell, performs clustering based on expression and other data, and computes markers for each cluster."
    ...
    def build_cwltool_cmd_sprm(**kwargs):
        ...
        input_parameters = [
            ...
            {"parameter_name": "--options_preset", "value": "3D"},
    ...
    t_send_create_dataset = PythonOperator(
        ...
        op_kwargs={
            ...
            "pipeline_shorthand": "3DCellComposer + SPRM",
        },
    )
