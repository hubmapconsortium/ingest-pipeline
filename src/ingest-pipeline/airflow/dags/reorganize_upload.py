...
with HMDAG(
    ...
    t_maybe_keep_2 = BranchPythonOperator(
        ...
        provide_context=True,
        op_kwargs={
            "next_op": "t_maybe_multiassay",
            "bail_op": "set_dataset_error",
            "test_op": "split_stage_2",
        },
    )

    t_maybe_multiassay = BranchPythonOperator(
        task_id="maybe_multiassay",
        python_callable=pythonop_maybe_multiassay,
        provide_context=True,
        op_kwargs={
            "next_op": "t_run_md_multiassay_extract",
            "bail_op": "t_run_md_extract",
            "test_op": "split_stage_2",
        },
    )

    t_run_md_multiassay_extract = BashOperator(
    ...
    t_md_multiassay_consistency_tests = PythonOperator(
    ...
    (
        ...
        >> t_maybe_keep_2
        >> t_maybe_multiassay
        >> t_run_md_multiassay_extract
        >> t_md_multiassay_consistency_tests
        >> t_run_md_extract
