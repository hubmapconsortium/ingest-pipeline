...
HM_AF_CONFIG=/hive/users/hive/hubmap/dev/ingest-pipeline/src/ingest-pipeline/airflow/airflow.cfg
HM_AF_HOME=/hive/users/hive/hubmap/dev/ingest-pipeline/src/ingest-pipeline/airflow
...
HM_AF_CONN_SEARCH_API_CONNECTION=http://https%3a%2f%2fontoly-api.dev.hubmapconsortium.org/
