...
HM_AF_CONFIG=/hive/users/hive/hubmap/hivevm191-dev/ingest-pipeline/src/ingest-pipeline/airflow/airflow.cfg
HM_AF_HOME=/hive/users/hive/hubmap/hivevm191-dev/ingest-pipeline/src/ingest-pipeline/airflow
