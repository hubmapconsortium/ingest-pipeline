...
HM_AF_CONFIG=/hive/users/hive/hubmap/vm023-cmudev/ingest-pipeline/src/ingest-pipeline/airflow/airflow.cfg
HM_AF_HOME=/hive/users/hive/hubmap/vm023-cmudev/ingest-pipeline/src/ingest-pipeline/airflow
