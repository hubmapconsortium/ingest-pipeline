...
class IMSDataCollection(DataCollection):
    ...
    expected_files = [
        ("*-spatial_meta.txt", "JSON"),
        ("raw_microscopy/*-AF_raw.czi", "CZI"),
        ("raw_microscopy/*-MxIF_raw.czi", "CZI"),
        ("raw_microscopy/*-PAS_raw.scn", "SCN_TIFF"),
        (
        ...
        ("processed_microscopy/*-mxIF_toIMS.ome.tiff", "OME_TIFF"),
        ("processed_microscopy/*-AF_pAF_toIMS.ome.tiff", "OME_TIFF"),
        ("processed_microscopy/*-pas_toIMS.ome.tiff", "OME_TIFF"),
        ("IMS/*-instrument_metadata.yml", "YAML"),
        ("IMS/*-peak_metadata.csv", "IGNORE"),
        ("IMS/*-tform_to_microscopy_metadata.txt", "MTXTFORM"),
        ("IMS/columnar/*.csv", "IGNORE"),
        ("IMS/imzml/*.ibd", "IGNORE"),
        ("IMS/imzml/*.imzML", "IMZML"),
        ("IMS/tif/*.ome.tiff", "OME_TIFF"),
        ("IMS/tif/individual_final/*.tiff", "OME_TIFF"),
    ]
