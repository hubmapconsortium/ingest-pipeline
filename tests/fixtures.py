...
ext_error_formatted = [
    ...
    "",
    "<b>What to do next</b>",
    f"If you have questions about your upload, please schedule an appointment with Data Curator Brendan Honick: {CURATION_OFFICE_HOURS_SCHEDULING_LINK}.",
    "",
